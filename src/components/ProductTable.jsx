...
import { MdKeyboardArrowLeft, MdKeyboardArrowRight, MdPhotoSizeSelectActual, MdOutlineNoPhotography } from "react-icons/md";
  ...
  const dataProducts = (prod) => {
    const arrayProducts = prod.map((element) => {
      const result ={
        col1: element.name,
        col2: element.type,
        col3: element.image ? <MdPhotoSizeSelectActual/> : <MdOutlineNoPhotography/>,
        col4: element.price,
